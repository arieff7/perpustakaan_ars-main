                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="peminjaman/create">
                            <button type="button" class="btn  btn-dark btn-lg"><i class="mr-2" data-feather="plus-circle"></i>Tambah Peminjaman</button>
                        </a>
                    </div>
                </div>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <form action="/pengembalian/<?= $item['id_pinjam']; ?>" method="POST" class="d-inline">
                                                    ...
                                                    <!-- Modal Button -->
                                                    <button type="button" class="btn btn-sm btn-icon btn-dark" data-toggle="modal" data-target="#updatePeminjaman" data-whatever="@getbootstrap"><i class="mr-2" data-feather="check-square"></i>Ubah Status</button>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn  btn-dark">Ubah Status Peminjaman</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
